...
Original file is located at
    https://colab.research.google.com/drive/1vkeZNAqBgCARlDBnWuJs5A4iaOZP-maL
"""
...
# Example usage
wav_file_path = '/wav-music.wav'  # Replace with your WAV file path
...
# Example usage
wav_file_path = '/wav-music3.wav'  # Replace with your WAV file path
generate_spectrogram(wav_file_path)